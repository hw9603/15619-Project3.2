...
q2() {
  ...
  #
  # A. Rigidity of the structured data
  # B. Data Integrity
...
q3() {
  ...
  # storing unstructured data such as Task 3?
  #
  # A. Document Storage
...
q4() {
  # Question:
  # Which of the following is a direct result of normalizing
  # the schema in a SQL database?
  #
  # A. Lesser Data Redundancy
